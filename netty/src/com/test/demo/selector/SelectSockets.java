package com.test.demo.selector;
...
public class SelectSockets {
	...
	public void go(String[] argv) throws Exception {
		...
		SelectionKey selectionKey = serverChannel.register(selector,
				SelectionKey.OP_ACCEPT);
		// This may block for a long time. Upon returning, the selected set
		// contains keys of the ready channels
		while (true) {
