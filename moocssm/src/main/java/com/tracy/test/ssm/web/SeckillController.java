package com.tracy.test.ssm.web;
...
import com.tracy.test.ssm.dto.SeckillResult;
...
public class SeckillController {
	...
	public SeckillResult<SeckillExecution> execute(
		...
		try {
			...
			//通过存储过程获取
			SeckillExecution seckillExecution = seckillService.excuteSeckillProcedure(
